...
def update_graph(dropdown1):
    ...
    fig_swimming = px.bar(df_swimming, y="activity", x="Burnt Calorie", color = 'Severity',
                         ...
                         color_discrete_map={'Low':'yellow', 'Moderate':'lightblue', 
                                             'High':'lightgreen','Very High':'darkcyan','Extreme':'Red'})
    ...
    fig_swimming.update_yaxes(ticksuffix = "  ")
    ...
    fig_walking.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_walking.update_yaxes(ticksuffix = "  ")
    ...
    fig_cycling.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_cycling.update_yaxes(ticksuffix = "  ")
    ...
    fig_dancing.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_dancing.update_yaxes(ticksuffix = "  ")
    ...
    fig_climbing.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_climbing.update_yaxes(ticksuffix = "  ")
    ...
    fig_children.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_children.update_yaxes(ticksuffix = "  ")
    ...
    fig_others.update_layout(template = 'plotly_dark',
              ...
              hovermode = False,
              width  = 1295, height = 500)
    fig_others.update_yaxes(ticksuffix = "  ")
