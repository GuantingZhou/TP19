...
$cfg['blowfish_secret']					= '<]&p%I?x#IA|yShu-tvEeJ7b9.i|r8k7' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_pEYBP0qwWvNLgViMUa3z7DK/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://stopoholicau.com/wp-admin/?rand=44511094&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://stopoholicau.com/wp-admin/?rand=91135468&pma_logout=1';
